  ...
  const carsData = [
    {
      ...
      capacity: 4,
      baseRate: 2.50,
      fuelType: 'Бензин', fuelConsumptionCity: 10.5, fuelConsumptionHighway: 7.5, selfDriveAllowed: false,
      status: 'AVAILABLE',
      images: [],
      videos: [],
    },
    {
      ...
      capacity: 7,
      baseRate: 3.00,
      fuelType: 'Бензин', fuelConsumptionCity: 12.0, fuelConsumptionHighway: 8.5, selfDriveAllowed: false,
      status: 'AVAILABLE',
      images: [],
      videos: [],
    },
    {
      ...
      capacity: 4,
      baseRate: 2.70,
      fuelType: 'Дизель', fuelConsumptionCity: 9.5, fuelConsumptionHighway: 6.5, selfDriveAllowed: true,
      status: 'AVAILABLE',
      images: [],
      videos: [],
    },
    {
      ...
      capacity: 4,
      baseRate: 2.40,
      fuelType: 'Дизель', fuelConsumptionCity: 10.0, fuelConsumptionHighway: 7.0, selfDriveAllowed: false,
      status: 'AVAILABLE',
      images: [],
      videos: [],
    },
    {
      ...
      capacity: 12,
      baseRate: 4.00,
      fuelType: 'Бензин', fuelConsumptionCity: 11.5, fuelConsumptionHighway: 8.0, selfDriveAllowed: true,
      status: 'AVAILABLE',
      images: [],
      videos: [],
    },
