          ...
          <div className="p-5">
            ...
            {activeTab === 'pricing' && (
              <div className="grid gap-5 lg:grid-cols-3">
                ...
                <Field label="Табличка + допомога з багажем €" hint="Єдина сервісна опція: водій зустрічає клієнта з табличкою і допомагає з валізами. Обирається під час оформлення."><input type="number" step="0.01" value={draft.meetAndGreetFee} onChange={(e) => updateDraft('meetAndGreetFee', e.target.value)} className={inputClass()} /></Field>
